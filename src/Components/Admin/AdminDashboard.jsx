...
export const AdminDashboard = () => {
  ...
  const handleRefreshAPi = async (e) => {
    ...
    e.preventDefault();
    axios
      .get("https://horse-bet.onrender.com/api/allDataForCountryapi/allDataForCountry")
      .then((data) => {
        setLoadingg(false);
        const country = [
          ...new Set(
  ...
  async function fetchData(uid) {
    ...
    try {
      await axios
        .get(
          `https://horse-bet.onrender.com/api/allDataForCountryapi/getTimesOfRacing?id=${uid}`
        )
        .then((res) => {
          setLoadingg(false);
  ...
  const handleGetLiveData = async (data) => {
    ...
    if (!liveTrue) {
      ...
      try {
        await axios
          .get(
            `https://horse-bet.onrender.com/api/allDataForCountryapi/getliveData?id=${data?.uid}&streamId=${id}`
          )
          .then((res) => {
